...
LADD/winter_moscow_2018/ImageSets/Main/train.txt > full_train_ds/ImageSets/Main/train.txt
...
LADD/winter_moscow_2018/ImageSets/Main/trainval.txt > full_train_ds/ImageSets/trainval.txt
...
LADD/winter_moscow_2018/ImageSets/Main/val.txt > full_train_ds/ImageSets/Main/val.txt
...
LADD/winter_moscow_2018/ImageSets/Main/test.txt > full_train_ds/ImageSets/Main/test.txt
